...
var lcov_fn_match = "^FN:[0-9]\\{1,\\},([a-zA-Z0-9_]\\{1,\\})$"
var gocover_match = "^[a-zA-Z/]\\{1,\\}\\.go:[0-9]\\{1,\\}\\.[0-9]\\{1,\\},[0-9]\\{1,\\}\\.[0-9]\\{1,\\} [0-9]\\{1,\\} [0-9]\\{1,\\}$"
...
router.get( "/upload", function( req, res, next )
{
    ...
    res.render( "upload", {
        lcov_regex: lcov_fn_match,
        gocov_regex: gocover_match,
        proto: req.protocol,
        host: req.hostname
    } )
} );
